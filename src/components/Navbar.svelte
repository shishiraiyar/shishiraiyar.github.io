...
<div class="container">
    ...
    <nav>
        <a class="nav-item" href="/notes"><span>Notes</span></a>
        <a class="nav-item" href="/projects"><span>Projects</span></a>
        <a class="nav-item" href="/about"><span>About Me</span></a>
        ...
        <button on:click={toggleDarkMode}> 
            ...
            {:else}
                <svg width="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.15" d="M3 17C10.952 18.6176 16.6829 8.75775 11 3C16.0007 3.13144 20 7.11149 20 12C20 16.9715 16.1188 21 11 21C7.77111 21 4.65938 19.4319 3 17Z" fill="#000000"/>
